...
from Project_Figure import figure_ur
from Project_Figure import figure_business
...
app.layout=html.Div([
	...
	html.Div([
		...
		html.Div([
			dcc.Graph(id="ease", figure=figure_business)
			], className="four columns"),
		html.Div([
			dcc.Graph(id="ur", figure=figure_ur)
			], className="four columns"),
...
def update_pie_imp(input_value_2):
	...
	layout_imp=dict(title="Imported products")
	return dict(data=[trace_imp], layout=layout_imp)
...
def update_pie_imp(input_value_3):
	...
	layout_exp=dict(title="Exported products")
	return dict(data=[trace_exp], layout=layout_exp)
